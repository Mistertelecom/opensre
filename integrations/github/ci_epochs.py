...
Git authorship identifies the fixer; it does not establish analytics account ownership.
"""
...
class Observer:
    ...
    def __init__(
        ...
        self.number = number
        self.client = GitHubRestClient(_github_token())
        self.path = out_dir / f"{owner}__{repo}__pr{number}.json"
